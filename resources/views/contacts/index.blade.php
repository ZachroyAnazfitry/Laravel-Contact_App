                ...
                <tbody>
                  ...
                  @if ($contacts->count())
                    ...
                    <tr>
                        ...
                        <td width="150">
                          <a href="/contacts/show" class="btn btn-sm btn-circle btn-outline-info" title="Show"><i class="fa fa-eye"></i></a>
                          <a href="/contacts/edit, $contacts->id" class="btn btn-sm btn-circle btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></a>
